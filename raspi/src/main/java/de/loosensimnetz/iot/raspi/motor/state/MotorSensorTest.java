...
public class MotorSensorTest {
	...
	public void testInitialIsStateMotorStateStoppedInitial() {
		...
		assertTrue("Initial state should be MotorStoppedInitial", sensor.getState() instanceof MotorStateStoppedInitial);
	}
	...
	public void testTransitionFromInitialToMovingDown() {
		...
		// Update sensor readings after 1000 ms
		sensor.update(1000L);
	...
	public void testTransitionFromMovingDownContinued() {
		...
		// Update again after 4000 ms
		sensor.update(4000L);
	
		assertTrue("State should still be MotorMovingDown", sensor.getState() instanceof MotorStateMovingDown);
	}
	
	@Test
	public void testTransitionFromMovingDownTooEarly() {
	...
	@Test
	public void testTransitionFromMovingDownTooLate() {
